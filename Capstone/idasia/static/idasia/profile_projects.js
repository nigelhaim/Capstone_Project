document.addEventListener('DOMContentLoaded', function(){
	...
	var profile = JSON.parse(document.getElementById("profile_user").textContent);
	let profile_f = profile['profile_id'];
	console.log("Signed in user is" + profile_f);
	display_ideas(profile_f);
});

function display_ideas(id){
	document.querySelector('#show-ideas').innerHTML = '';
	fetch('profile_projects/' + id)
